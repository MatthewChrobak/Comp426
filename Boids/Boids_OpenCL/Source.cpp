...
int mainss()
{
	...
	cmMemObjs[0] = clCreateBuffer(cxMainContext, CL_MEM_READ_ONLY | CL_MEM_COPY_HOST_PTR, sizeof(cl_float) * iTestN, nullptr, NULL);
	// allocate the second source buffer memory object
	cmMemObjs[1] = clCreateBuffer(cxMainContext, CL_MEM_READ_ONLY | CL_MEM_COPY_HOST_PTR, sizeof(cl_float) * iTestN, nullptr, NULL);
	...
	// read output
	ciErrNum = clEnqueueReadBuffer(cqCommandQue,cmMemObjs[2], CL_TRUE, 0, iTestN * sizeof(cl_float), nullptr, 0, NULL, NULL);
